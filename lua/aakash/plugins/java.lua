-- [[ Java ]]
-- JDTLS joins the shared LSP registry; nvim-jdtls adds refactors and debug/test actions.
-- Mason supplies the server and extension JARs. See :help jdtls and :help jdtls.dap.

-- [[ Debugger and test extensions ]]
...
-- [[ Project workspaces ]]
-- Give equally named projects separate JDTLS caches without relying on the cwd.
