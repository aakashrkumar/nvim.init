-- [[ Profiling ]]
-- Overseer runs captures; Samply and PerfAnno display the results.
-- This module exposes the commands and mappings. Shared launch behavior lives
-- in aakash.performance, and language modules contribute their own templates.
...
return {
    {
        ...
        init = function()
            ...
            vim.api.nvim_create_user_command(
                'ProfileOpen',
                function() require('aakash.performance').open() end,
                { desc = 'Open this project’s last profile' }
            )
            vim.api.nvim_create_user_command(
                'ProfileOutput',
