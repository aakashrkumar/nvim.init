...
---@field interactive? boolean open focused output and forward input to the task
...
local idf_tasks = {
    ...
    { args = { 'flash', 'monitor' }, resource = 'serial', tags = { 'RUN' }, interactive = true },
    { args = { 'monitor' }, resource = 'serial', interactive = true },
    { args = { 'menuconfig' }, interactive = true },
    { args = { 'size' } },
...
local pio_tasks = {
    ...
    { args = { 'run', '--target', 'upload', '--target', 'monitor' }, resource = 'serial', tags = { 'RUN' }, interactive = true },
    { args = { 'device', 'monitor' }, resource = 'serial', interactive = true },
    { args = { 'test' }, tags = { 'TEST' } },
