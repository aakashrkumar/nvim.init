-- [[ User interface ]]
-- The theme supplies shared highlights; Noice and Snacks own distinct UI
-- services. Writing-view geometry below preserves a readable, padded page.
...
function writing_view.width()
    if not writing_view.has_frame() then return math.max(1, vim.o.columns - 2 * writing_view.horizontal_screen_margin) end
...
function writing_view.height() return writing_view.has_frame() and math.max(1, vim.o.lines - 2) or vim.o.lines end

function writing_view.canvas_width() return writing_view.width() + 2 * writing_view.horizontal_padding end

function writing_view.canvas_height() return writing_view.height() end
            ...
            require('catppuccin').setup {
                ...
                custom_highlights = function(colors)
                    return {
                        ...
                        LspDocumentation = { fg = colors.text, bg = colors.mantle },
                        LspDocumentationBorder = { fg = colors.surface1, bg = colors.none },
                        ...
                        DapViewNormal = { fg = colors.text, bg = colors.crust },
                        DapViewCursorLine = { bg = colors.surface0 },
                        DapViewSeparator = { fg = colors.surface2, bg = colors.crust },
                        DapViewStatusLine = { fg = colors.subtext1, bg = colors.mantle },
                        NvimDapViewTab = { fg = colors.overlay1, bg = colors.crust },
                        NvimDapViewTabFill = { bg = colors.crust },
                        NvimDapViewTabSelected = { fg = colors.crust, bg = colors.blue, bold = true },
                        NvimDapViewFrameCurrent = { fg = colors.text, bg = colors.surface0, bold = true },
                        NvimDapViewWatchUpdated = { fg = colors.yellow, bg = colors.crust, bold = true },
                        NvimDapViewWatchError = { fg = colors.red, bg = colors.crust },
                        NvimDapViewVirtualText = { fg = colors.subtext0 },
                        NvimDapViewVirtualTextUpdated = { fg = colors.yellow, bold = true },
        ...
        opts = {
            ...
            image = {
                ...
                doc = {
                    ...
                    -- This relies on Snacks placement/extmark internals; check centering
                    -- after upgrading Snacks.
            ...
            zen = {
                ...
                on_open = function(win)
                    ...
                    local function sync_canvas()
                        ...
                        if canvas and canvas:valid() then return end
                    ...
                    vim.api.nvim_create_autocmd('VimResized', {
                        group = win.augroup,
                        callback = function() vim.schedule(sync_canvas) end,
                    })
                end,
                win = {
                    ...
                    backdrop = {
                        ...
                        win = {
                            zindex = 38,
                            wo = {
                                winhighlight = 'Normal:WritingViewGutter,EndOfBuffer:WritingViewGutter',
                            },
                        },
                    },
                    wo = {
